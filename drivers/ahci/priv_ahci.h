#ifndef _PRIV_AHCI_H_
#define _PRIV_AHCI_H_
...
typedef struct tagFIS_DMA_SETUP
{
	...
	//uint32_t 1&2
        ...
        uint16_t   DMAbufferID;    // DMA Buffer Identifier. Used to Identify DMA buffer in host memory. SATA Spec says host specific and not in Spec. Trying AHCI spec might work.
